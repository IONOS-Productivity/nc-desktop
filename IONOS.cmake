...
set( APPLICATION_EXECUTABLE "STRATO_HiDrive_Next" )
...
set( APPLICATION_SERVER_URL "https://storage.strato.fr" CACHE STRING "URL for the server to use. If entered, the UI field will be pre-filled with it" FORCE)
set( WHITELABEL_BRAND "IONOS")
...
if(APPLE AND APPLICATION_NAME STREQUAL "STRATO HiDrive Next")
    set( APPLICATION_ICON_NAME "strato_hidrive_next-macOS" )
    message("Using macOS-specific application icon: ${APPLICATION_ICON_NAME}")
endif()

if(APPLICATION_NAME STREQUAL "STRATO HiDrive Next")
    set( WHITELABEL_BRAND "STRATO" )
endif()