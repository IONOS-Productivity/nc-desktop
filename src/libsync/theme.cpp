...
QVariantMap Theme::systemPalette() const
{
    ...
    const auto &palette = IONOSPalette;
    return QVariantMap {
        { QStringLiteral("base"), palette.base().color() },
        { QStringLiteral("alternateBase"), palette.alternateBase().color() },
        { QStringLiteral("text"), palette.text().color() },
        { QStringLiteral("toolTipBase"), palette.toolTipBase().color() },
        { QStringLiteral("toolTipText"), palette.toolTipText().color() },
        { QStringLiteral("brightText"), palette.brightText().color() },
        { QStringLiteral("buttonText"), palette.buttonText().color() },
        { QStringLiteral("button"), palette.button().color() },
        { QStringLiteral("highlightedText"), palette.highlightedText().color() },
        { QStringLiteral("placeholderText"), palette.placeholderText().color() },
        { QStringLiteral("windowText"), palette.windowText().color() },
        { QStringLiteral("window"), palette.window().color() },
        { QStringLiteral("dark"), palette.dark().color() },
        { QStringLiteral("highlight"), palette.highlight().color() },
        { QStringLiteral("light"), palette.light().color() },
        { QStringLiteral("link"), palette.link().color() },
        { QStringLiteral("midlight"), palette.midlight().color() },
        { QStringLiteral("mid"), palette.mid().color() },
        { QStringLiteral("linkVisited"), palette.linkVisited().color() },
        { QStringLiteral("shadow"), palette.shadow().color() },
    };
}
