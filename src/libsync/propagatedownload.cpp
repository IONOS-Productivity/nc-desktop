...
Q_LOGGING_CATEGORY(lcGetJob, "hidrivenext.sync.networkjob.get", QtInfoMsg)
Q_LOGGING_CATEGORY(lcPropagateDownload, "hidrivenext.sync.propagator.download", QtInfoMsg)
